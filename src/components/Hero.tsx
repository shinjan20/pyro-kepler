...
const Hero = () => {
    return (
        <div className="relative min-h-[95vh] flex flex-col justify-center pt-20 pb-12 overflow-hidden bg-slate-50 dark:bg-[#030712] transition-colors duration-500">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none z-0 w-full max-w-[100vw]">
            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10 pt-16">
                <div className="text-center max-w-4xl mx-auto">

                    {/* Glowing Notification Pill */}
                    <div className="inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full animated-border-badge backdrop-blur-3xl bg-white/60 dark:bg-slate-900/60 text-brand-700 dark:text-brand-300 font-semibold text-xs sm:text-sm mb-6 sm:mb-10 shadow-[0_0_30px_rgba(99,102,241,0.25)] dark:shadow-[0_0_30px_rgba(99,102,241,0.15)] animate-in fade-in slide-in-from-bottom-4 duration-700 z-20 relative">
                    ...
                    <h1 className="text-4xl sm:text-7xl md:text-[6.5rem] font-heading font-black tracking-tighter text-slate-900 dark:text-white mb-8 leading-[1.05] animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
                    ...
                    <p className="text-base sm:text-lg md:text-2xl text-slate-600 dark:text-slate-400 mb-8 sm:mb-12 max-w-2xl mx-auto font-medium animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 px-4 sm:px-0 w-full lg:w-max mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                ...
                <div className="mt-16 sm:mt-24 w-full max-w-7xl mx-auto overflow-hidden">
                    ...
                    <div className="glass rounded-3xl py-8 border border-white/40 dark:border-white/5 relative overflow-hidden mask-edges shadow-xl shadow-brand-500/5 w-full max-w-[100vw]">
                ...
                {/* Floating Stats Grid */}
                <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-4 px-4 sm:px-0 w-full max-w-[100vw] overflow-hidden">
