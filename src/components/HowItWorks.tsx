            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-3 gap-12 relative">
                    ...
                    {[
                        ...
                        <div key={index} className="relative z-10 flex flex-col items-center text-center group transition-all duration-300 hover:-translate-y-2 hover:drop-shadow-xl bg-white dark:bg-slate-900/50 p-6 rounded-3xl border border-transparent hover:border-slate-200 dark:hover:border-slate-800">
                            <div className={`w-24 h-24 mb-6 rounded-2xl ${item.color} shadow-lg ${item.shadow} flex items-center justify-center transform transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}>
                                {item.icon}
                            </div>
                            <div className="text-brand-600 dark:text-brand-400 font-bold text-sm tracking-widest uppercase mb-2">
                                Step {item.step}
                            </div>
